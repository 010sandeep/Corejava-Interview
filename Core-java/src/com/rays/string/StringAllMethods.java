...
public class StringAllMethods {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("String IndexOf 'n': " + name.indexOf("r"));
		 */
		...
		System.out.println("String replace: " + name.replace("a", "t"));
		...
		System.out.println("String startsWith 'S': " + name.startsWith("S"));

		// Check if string ends with "d"
		System.out.println("String endsWith 'r': " + name.endsWith("r"));
